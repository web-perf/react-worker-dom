...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WorkerDomNodeImpl = __webpack_require__(162);
	...
	var _ReactMount = __webpack_require__(28);
	
	var _ReactMount2 = _interopRequireDefault(_ReactMount);
	
	var _inject = __webpack_require__(165);
	
	var _inject2 = _interopRequireDefault(_inject);
	
	var _NodeIDOperations = __webpack_require__(166);
	
	var _NodeIDOperations2 = _interopRequireDefault(_NodeIDOperations);
	...
	var ReactWorkerDom = function () {
	    function ReactWorkerDom(worker, container) {
	        ...
	        this.channel = new _channel2.default(worker);
	        this.channel.onMessage(this.handleMessage.bind(this));
	        this.channel.send(_constants.RENDER_TIME, {
	            time: 1,
	            count: 0
	        });
	    }
	    ...
	    _createClass(ReactWorkerDom, [{
	        ...
	        value: function handleMessage(data) {
	            ...
	            switch (data.type) {
	                case _constants.RENDER_QUEUE:
	                    var start = performance.now();
	                    data.args.forEach(function (msg) {
	                        return _this.handleRenderQueueMessage(msg);
	                    });
	                    this.channel.send(_constants.RENDER_TIME, {
	        ...
	        value: function handleRenderQueueMessage(data) {
	            ...
	            var node;
	            if (data.method !== _constants.CONSTRUCTOR) {
	                node = _NodeIDOperations2.default.get(data.guid);
	                //console.log('%s(%s:%s).%s', node.el, node.guid, node.reactId, data.method, ...data.args);
	            }
	            switch (data.method) {
	                case _constants.CONSTRUCTOR:
	                    node = new (Function.prototype.bind.apply(_WorkerDomNodeImpl2.default, [null].concat([data.guid, data.reactId], _toConsumableArray(data.args))))();
	                    _NodeIDOperations2.default.add(node);
	                    break;
	                case _constants.RENDER:
	                    // Should only be called once per worker
	                    this.container.appendChild(node.ref);
	                    _ReactMount2.default.registerContainer(node.ref);
	                    break;
	                case _constants.ADD_CHILD:
	                    node.addChild(_NodeIDOperations2.default.get(data.args[0]));
	                    break;
	                case _constants.ADD_CHILD_INDEX:
	                    node.addChildAtIndex(_NodeIDOperations2.default.get(data.args[0]), data.args[1]);
	                    break;
	                case _constants.REMOVE_CHILD:
	                    node.removeChild(_NodeIDOperations2.default.get(data.args[0]));
	                    break;
	                case _constants.REMOVE_CHILD_INDEX:
	                    var removedNodeGuid = node.removeChildAtIndex(data.args);
	                    removedNodeGuid && _NodeIDOperations2.default.remove(removedNodeGuid);
	                    break;
	                case _constants.REPLACE_AT:
	                    var oldNode = _NodeIDOperations2.default.getByReactId(data.args[0]);
	                    node.replace(oldNode);
	                    _NodeIDOperations2.default.remove(oldNode.guid);
	                    break;
	                case _constants.SET_ATTRIBUTES:
	                    (_node = node).setAttributes.apply(_node, _toConsumableArray(data.args));
	                    break;
	                case _constants.SET_CONTENT:
	                    (_node2 = node).setContent.apply(_node2, _toConsumableArray(data.args));
	                    break;
	                case _constants.ADD_EVENT_HANDLERS:
	                    (_node3 = node).addEventHandlers.apply(_node3, [this.container, this.onEvent.bind(this)].concat(_toConsumableArray(data.args)));
	                    break;
	                case _constants.REMOVE_EVENT_HANDLERS:
	        ...
	        key: 'onEvent',
	        value: function onEvent(handler, syntheticEvent, reactId, e) {
	            this.channel.send(_constants.EVENT, {
	                reactId: reactId,
	                eventType: handler,
	...
	module.exports = {
	    render: function render(worker, container) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactBrowserEventEmitter = __webpack_require__(29);
	
	var _ReactBrowserEventEmitter2 = _interopRequireDefault(_ReactBrowserEventEmitter);
	
	var _EventConstants = __webpack_require__(30);
	...
	var WorkerDomNodeImpl = function () {
	    function WorkerDomNodeImpl(guid, reactId, el, options) {
	    ...
	    _createClass(WorkerDomNodeImpl, [{
	        key: 'addChild',
	        value: function addChild(node, afterNode) {
	            this.ref.appendChild(node.ref);
	        }
	    }, {
	        key: 'addChildAtIndex',
	        value: function addChildAtIndex(node, index) {
	        ...
	        value: function removeChildAtIndex(index) {
	        ...
	        key: 'replace',
	        value: function replace(oldNode) {
	        ...
	        value: function addEventHandlers(container, onEvent) {
	            var _this = this;
	            ...
	            handlers.forEach(function (handler) {
	                switch (_this.el) {
	                    case 'form':
	                        _this._listeners = [_ReactBrowserEventEmitter2.default.trapBubbledEvent(_EventConstants2.default.topLevelTypes.topReset, 'reset', _this.ref), _ReactBrowserEventEmitter2.default.trapBubbledEvent(_EventConstants2.default.topLevelTypes.topSubmit, 'submit', _this.ref)];
	                    // TODO - Add more cases of events that do not bubble
	                    // Look at trapBubbledEventsLocal in REactDomComponent in react-dom
	                }
	                _ReactBrowserEventEmitter2.default.listenTo(handler, container);
	                _ReactBrowserEventEmitter2.default.putListener(_this.reactId, handler, function (syntheticEvent, reactId, e) {
	        ...
	        value: function removeEventHandlers() {
	            _ReactBrowserEventEmitter2.default.deleteAllListeners(this.reactId);
	        }
	    }]);
...
/***/ function(module, exports) {
	...
	var Channel = function () {
	    ...
	    _createClass(Channel, [{
	        ...
	        key: 'serializeEvent',
	        value: function serializeEvent(e) {
	            var newTarget = {
	        ...
	        key: 'deserializeEvent',
	        value: function deserializeEvent(msg) {
...
/***/ function(module, exports) {
	...
	var ADD_CHILD = exports.ADD_CHILD = 'appendChild';
	var ADD_CHILD_INDEX = exports.ADD_CHILD_INDEX = 'addChildIndex';
	var REMOVE_CHILD = exports.REMOVE_CHILD = 'removeChild';
	var REMOVE_CHILD_INDEX = exports.REMOVE_CHILD_INDEX = 'removeChildIndex';
	var REPLACE_AT = exports.REPLACE_AT = 'replaceAt';
	...
	var REMOVE_EVENT_HANDLERS = exports.REMOVE_EVENT_HANDLERS = 'removeEventHandlers';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactReconcileTransaction = __webpack_require__(125);
	
	var _ReactReconcileTransaction2 = _interopRequireDefault(_ReactReconcileTransaction);
	
	var _ReactDefaultBatchingStrategy = __webpack_require__(92);
	...
	function inject() {
	    ...
	    _ReactInjection2.default.EventEmitter.injectReactEventListener(_ReactEventListener2.default);
	
	    _ReactInjection2.default.EventPluginHub.injectEventPluginOrder(_DefaultEventPluginOrder2.default);
	    _ReactInjection2.default.EventPluginHub.injectInstanceHandle(_ReactInstanceHandles2.default);
	    _ReactInjection2.default.EventPluginHub.injectMount(_ReactMount2.default);
	
	    _ReactInjection2.default.EventPluginHub.injectEventPluginsByName({
...
/***/ function(module, exports) {
	...
	var NodeList = function () {
	    ...
	    _createClass(NodeList, [{
	        ...
	        key: 'getByReactId',
	        value: function getByReactId(reactId) {
